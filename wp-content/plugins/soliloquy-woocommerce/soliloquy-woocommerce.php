<?php
/**
 * Plugin Name: Soliloquy - WooCommerce Addon
 * Plugin URI:  http://soliloquywp.com
 * Description: Enables WooCommerce sliders in Soliloquy.
 * Author:      Soliloquy Team
 * Author URI:  http://soliloquywp.com
 * Version:     1.1.3
 * Text Domain: soliloquy-woocommerce
...
class Soliloquy_WooCommerce {
     ...
     * @var string
     */
    public $plugin_name = 'Soliloquy - WooCommerce Addon';
     ...
     * @var string
     */
    public $plugin_slug = 'soliloquy-woocommerce';
	...
	function updater( $key ) {
	    ...
	    $this->soliloquy_woocommerce = new Soliloquy_Updater( $args );
    ...
    public static function get_instance() {
        ...
        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Soliloquy_WooCommerce ) ) {
            self::$instance = new Soliloquy_WooCommerce();
        }
...
$soliloquy_woocommerce = Soliloquy_WooCommerce::get_instance();