 ...
 * Contact Card Widget
 *
 * Card widget with fields for name, title, phone, fax, email, and image.
 *
 * @package   Contact_Card_Widget
 ...
 * Description:       Card widget with fields for name, title, phone, fax, email, and image.
 * Version:           1.3.0
 * Author:            Pressware, LLC
...
if ( ! defined( 'WPINC' ) || class_exists( 'Contact_Card_Widget' ) ) {
	die;
}
 ...
 * @since    1.0.0
 */
function pressware_run_contact_card_widget() {
	add_action( 'widgets_init', create_function( '', 'register_widget( "Contact_Card_Widget" );' ) );
}
pressware_run_contact_card_widget();
